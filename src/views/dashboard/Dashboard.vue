<template class="overflow-hidden">
  <div class="container py-2 bg-white height-max">
    ...
    <div class='text-center p-2'>
      <router-link to="/new-statement" class="btn btn-lg btn-primary"><fa icon="project-diagram" /> <small>Create New Tree</small></router-link>
      <router-link to="/search" class="btn btn-lg btn-outline-primary"><fa icon="search" /> <small>Search Trees</small></router-link>
    </div>
