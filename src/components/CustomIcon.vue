<template>
  <svg id="Layer_1" role="img" :style="{height: height}" :class="customClass" data-prefix="fas" enable-background="new 0 0 512.203 512.203"  viewBox="0 0 512.203 512.203" xmlns="http://www.w3.org/2000/svg">
