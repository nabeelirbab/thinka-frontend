<template>
  <div>
    <div 
      ...
      tabindex="-1" 
      role="dialog" 
      :data-keyboard="closeable"
      :data-backdrop="!closeable ? 'static' : true" 
      aria-hidden="true" 
    >
      <div 
        v-bind:class="'modal-' + size" class="modal-dialog" role="document" :style="paddingTop ? {'padding-top': paddingTop} : {}">
