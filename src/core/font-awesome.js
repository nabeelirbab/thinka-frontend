...
library.add(fas, faTwitter, faInstagram, faCheck, faProjectDiagram, faSearch, faChartLine, faList, faCloud, faThumbsUp, faThumbsDown, faColumns, faLevelUpAlt, faCertificate, faCommentDots, faFolderPlus, faFolderMinus, faEye, faChevronDown, faChevronRight, faSave, faUndoAlt, faSpinner, faHome, faTree, faBookmark, faBell, faEllipsisV, faUserCircle, faSun, faExclamationTriangle, faCut, faArrowsAlt, faLock, faQuoteLeft, faQuoteRight, faHandPointDown, faFlag, faShareSquare, faUnlink, faStar, faBookReader);
